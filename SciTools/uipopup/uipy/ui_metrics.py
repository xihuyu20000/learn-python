...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.btn_graph = QPushButton(self.frame_4)
        self.btn_graph.setObjectName(u"btn_graph")

        self.horizontalLayout_3.addWidget(self.btn_graph)
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QCoreApplication.translate("Form", u"\u8ba1\u91cf\u5206\u6790", None))
        ...
        self.label_6.setText(QCoreApplication.translate("Form", u"\u5173\u952e\u5b57\u5b57\u6bb5", None))
        ...
        self.lineEdit_field_org.setText(QCoreApplication.translate("Form", u"\u673a\u6784", None))
