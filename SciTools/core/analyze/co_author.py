...
class CoauthorHierarchyCluster:
    """
    作者共著聚类
    ...
    def stat_cocon_freq(self):
        ...
        self.data_list_list = [[pair.split(Cfg.seperator)[0], pair.split(Cfg.seperator)[1], times] for pair, times in
                               pair_counter.items()]
...
if __name__ == '__main__':
    ...
    cc = CoauthorHierarchyCluster(df, col_name='A1', freq_threshold=1, cocon_threshold=3)
    cc.run()
