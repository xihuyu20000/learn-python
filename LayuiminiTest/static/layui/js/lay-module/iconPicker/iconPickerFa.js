...
layui.define(['laypage', 'form'], function (exports) {
    ...
    IconPicker.prototype.render = function (options) {
        var opts = options,
            ...
            PAGE_ID = 'layui-iconpicker-basic-' + tmp,
        ...
        var a = {
            ...
            createList: function (text) {
                ...
                if (page) {
                    ...
                    pageHtml = '<div class="layui-iconpicker-basic" id="' + PAGE_ID + '">' +
                        '<div class="layui-iconpicker-basic-count">' +
                        '<span id="' + PAGE_ID + '-current">1</span>/' +
                        '<span id="' + PAGE_ID + '-pages">' + _pages + '</span>' +
                        ' (<span id="' + PAGE_ID + '-length">' + l + '</span>)' +
                        '</div>' +
                        '<div class="layui-iconpicker-basic-operate">' +
            ...
            // 分页
            page: function () {
                var icon = '#' + PAGE_ID + ' .layui-iconpicker-basic-operate .layui-icon';
